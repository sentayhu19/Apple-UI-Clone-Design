<template>
    <div>
        <div class="p-8">
            <div class="mb-4">
        <span class="text-[32px] font-medium">Store.</span>
    <span class="text-[#6e6e73;] text-[32px]">
        The best way to buy the products you love.
    </span>
</div>
    <div class="flex items-center mb-3">
    <img class="rounded-full w-[35px] h-[35px] mr-3" src="../assets/needhelp.jpg"/>
    <div class="flex flex-col">
        <p>Need Shoping help?</p>
        <p class="text-[#06c;]">Ask a Specilalist</p>
    </div>
</div>
<div class="flex items-center">
    <img class="rounded-full w-[35px] h-[35px] mr-3" src="../assets/apple-msg-logo.png"/>
    <div class="flex flex-col">
        <p>Need Shoping help?</p>
        <p class="text-[#06c;]">Find one near you ></p>
    </div>
</div>
</div>
